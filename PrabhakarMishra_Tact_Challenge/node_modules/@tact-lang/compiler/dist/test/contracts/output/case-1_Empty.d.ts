...
export declare class Empty implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Empty>;
    static fromAddress(address: Address): Empty;
    ...
    private constructor();
    getA(provider: ContractProvider, x: bigint, y: bigint, z: boolean, m: Source): Promise<boolean>;
}
