...
const CounterContract_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"increament"}},
...
export class CounterContract implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'increament' | Deploy) {
        
        let body: Cell | null = null;
        if (message === 'increament') {
