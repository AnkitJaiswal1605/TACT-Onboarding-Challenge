...
describe('parseTransaction', () => {
    it('should parse transaction correctly', () => {
        ...
        const address = __1.Address.parse('0:83dfd552e63729b472fcbcc8c45ebcc6691702558b68ec7527e1ba403a0f31a8');
        ...
        const cell = __1.Cell.fromBoc(Buffer.from(tx, 'base64'))[0];
        const parsedTx = (0, parseTransaction_1.parseTransaction)(address.workChain, cell.beginParse());
    ...
    it('should parse tick/tock transactions', () => {
        ...
        const cell = __1.Cell.fromBoc(Buffer.from(tx, 'base64'))[0];
        const parsedTx = (0, parseTransaction_1.parseTransaction)(-1, cell.beginParse());
        console.warn(parsedTx);
    });
