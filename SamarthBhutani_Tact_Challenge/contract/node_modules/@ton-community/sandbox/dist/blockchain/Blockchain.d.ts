...
import { Executor, TickOrTock } from "@ton-community/sandbox/dist/executor/Executor";
import { BlockchainStorage } from "@ton-community/sandbox/dist/blockchain/BlockchainStorage";
import { Event } from "@ton-community/sandbox/dist/event/Event";
import { SandboxContractProvider } from "@ton-community/sandbox/dist/blockchain/BlockchainContractProvider";
import { TreasuryContract } from "@ton-community/sandbox/dist/treasury/Treasury";
import { GetMethodParams, LogsVerbosity, MessageParams, SmartContract, SmartContractSnapshot, Verbosity } from "@ton-community/sandbox/dist/blockchain/SmartContract";
import { AsyncLock } from "@ton-community/sandbox/dist/utils/AsyncLock";
...
export declare class Blockchain {
    ...
    runGetMethod(address: Address, method: number | string, stack?: TupleItem[], params?: GetMethodParams): Promise<import("@ton-community/sandbox/dist/blockchain/SmartContract").GetMethodResult>;
